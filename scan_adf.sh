...
SCAN_DIRECTORY=${SCAN_DIRECTORY:-/home/dasco/scanpi}
...
scanimage --output-file image-0001 --resolution $RESOLUTION --mode $MODE --format jpeg # 2>>stderr.log 1>>stdout.log ||>#scanimage --resolution $RESOLUTION --mode $MODE --format jpeg # 2>>stderr.log 1>>stdout.log || true
